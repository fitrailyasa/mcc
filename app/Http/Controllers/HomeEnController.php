...
class HomeEnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.en.index', compact('services', 'testimonials', 'about'));
    }
    ...
    public function about()
    {
        ...
        return view('pages.en.about', compact('about', 'services', 'testimonials'));
    }
    ...
    public function contact()
    {
        ...
        return view('pages.en.contact', compact('about', 'services', 'testimonials'));
    }
    ...
    public function services()
    {
        ...
        return view('pages.en.services', compact('services', 'about'));
    }
    public function servicesDetail(string $slug)
    {
        ...
        return view('pages.en.services-detail', compact('service', 'about'));
    }
    ...
    public function feedback()
    {
        ...
        return view('pages.en.feedback', compact('about', 'services', 'testimonials'));
    }
