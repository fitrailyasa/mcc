...
<button role="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
    data-bs-target=".formDelete{{ $package->id }}"><i class="fas fa-trash"></i><span class="d-none d-sm-inline">
        {{ __('Delete') }}</span></button>

<!-- Modal -->
<div class="modal fade formDelete{{ $package->id }}" tabindex="-1" role="dialog" aria-hidden="">
