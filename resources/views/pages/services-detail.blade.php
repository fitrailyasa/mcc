    ...
    <div id="services" class="container-fluid service pb-5">
        <div class="container pb-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p>{{ $service['desc'] }}</p>
                <a target="_blank" class="btn btn-primary rounded-pill py-2 mb-3 px-4" href="https://wa.me/{{ $about[0]->whatsapp }}?text=Hello, I want to order a package {{ $service['name'] }}">Book
                    Now</a>
