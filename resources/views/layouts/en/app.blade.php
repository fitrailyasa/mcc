        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-flex flex-wrap">
                    ...
                    <a href="https://wa.me/{{ $about->whatsapp }}" class="text-muted small me-4">
                        <i class="fab fa-whatsapp text-primary me-2"></i>{{ $about->whatsapp }}
                    </a>
                    <a href="mailto:{{ $about->email }}" class="text-muted small me-0">
                        <i class="fas fa-envelope text-primary me-2"></i>{{ $about->email }}
                    </a>
                </div>
            </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-12 text-center text-md-start mb-md-0">
                    <span class="text-body"><a href="#" class="border-bottom text-white"><i
                                class="fas fa-copyright text-light me-2"></i>{{ $about->title }}</a>, All right
                        reserved.</span>
                </div>
            </div>
        </div>
